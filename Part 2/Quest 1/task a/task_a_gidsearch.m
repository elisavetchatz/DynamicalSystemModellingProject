...
g2 = 100;
g3 = 60;
% g1_values = linspace(20, 100, 5);
% g2_values = linspace(20, 100, 5);
% g3_values =linspace(20, 100, 5);  
...
%     for g2 = g2_values
%         for g3 = g3_values
%             G_candidates{end+1} = diag([g1, g2, g3]);
%         end
%     end
% end

% am_values = 1:2:30; % filter poles
am = 1;
intial_cond = [0; 0; 0; 0; 0; 0; 0; 0]; % Initial conditions for the states and parameters

% % Define candidate initial conditions
% initial_conditions_list = {
%     [0; 0; 0; 0; 0; 0; 0; 0], ... % IC1: All zeros
% };
...
%                     disp(['Experiment ', num2str(experiment_num), ' of ', num2str(length(g1_values)*length(g2_values)*length(g3_values)*length(am_values)*length(initial_conditions_list))]);
...
% am = am_best;
initial_cond = [0; 0; 0; 0; 0; 0; 0; 0]; % Initial conditions for the states and parameters
